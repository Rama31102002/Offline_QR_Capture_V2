'use strict';
const CACHE='offline-qr-pwa-v3';
const ASSETS=['./','./index.html','./offline.html','./manifest.json','./assets/style.css','./assets/db.js','./assets/auth.js','./assets/camera.js','./assets/qr-reader.js','./assets/backup.js','./assets/app.js','./assets/jszip.min.js','./icons/icon-192.png','./icons/icon-512.png'];
